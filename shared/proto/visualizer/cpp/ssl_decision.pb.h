...
class ssl_decision_packet_Robot_Role : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_current_role(::std::string* current_role);
  ...
  inline void set_allocated_current_skill(::std::string* current_skill);
...
class ssl_decision_packet : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_strategy_name(::std::string* strategy_name);
...
inline void ssl_decision_packet_Robot_Role::set_allocated_current_role(::std::string* current_role) {
  if (current_role_ != &::google::protobuf::internal::kEmptyString) {
...
inline void ssl_decision_packet_Robot_Role::set_allocated_current_skill(::std::string* current_skill) {
  if (current_skill_ != &::google::protobuf::internal::kEmptyString) {
    delete current_skill_;
  }
  if (current_skill) {
    set_has_current_skill();
    current_skill_ = current_skill;
  } else {
    clear_has_current_skill();
    current_skill_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
  }
...
inline void ssl_decision_packet::set_our_color(::ssl_decision_packet_Color value) {
  assert(::ssl_decision_packet_Color_IsValid(value));
  set_has_our_color();
  our_color_ = value;
}
...
inline void ssl_decision_packet::set_our_side(::ssl_decision_packet_Side value) {
  assert(::ssl_decision_packet_Side_IsValid(value));
  set_has_our_side();
  our_side_ = value;
}
...
inline void ssl_decision_packet::set_allocated_strategy_name(::std::string* strategy_name) {
  if (strategy_name_ != &::google::protobuf::internal::kEmptyString) {
...
inline void ssl_decision_packet::set_allocated_comment(::std::string* comment) {
  if (comment_ != &::google::protobuf::internal::kEmptyString) {
    delete comment_;
  }
  if (comment) {
