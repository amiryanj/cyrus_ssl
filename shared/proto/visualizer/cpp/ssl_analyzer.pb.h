...
class ssl_analyzer_packet : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_ballintersectionwithourgoal(::ssl_analyzer_packet_point_2d* ballintersectionwithourgoal);
...
inline void ssl_analyzer_packet_RobotIntersectTime::set_color(::ssl_analyzer_packet_Color value) {
  assert(::ssl_analyzer_packet_Color_IsValid(value));
  set_has_color();
  color_ = value;
}
...
inline void ssl_analyzer_packet::set_allocated_ballintersectionwithourgoal(::ssl_analyzer_packet_point_2d* ballintersectionwithourgoal) {
  delete ballintersectionwithourgoal_;
  ballintersectionwithourgoal_ = ballintersectionwithourgoal;
  if (ballintersectionwithourgoal) {
    set_has_ballintersectionwithourgoal();
  } else {
    clear_has_ballintersectionwithourgoal();
  }
...
inline void ssl_analyzer_packet::set_allocated_comment(::std::string* comment) {
  if (comment_ != &::google::protobuf::internal::kEmptyString) {
    delete comment_;
  }
  if (comment) {
