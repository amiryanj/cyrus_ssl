...
class ssl_visualizer_packet : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_world_data(::ssl_world_packet* world_data);
  ...
  inline void set_allocated_analyzer_data(::ssl_analyzer_packet* analyzer_data);
  ...
  inline void set_allocated_decision_data(::ssl_decision_packet* decision_data);
  ...
  inline void set_allocated_planner_data(::ssl_planner_packet* planner_data);
...
inline void ssl_visualizer_packet::set_allocated_world_data(::ssl_world_packet* world_data) {
  delete world_data_;
...
inline void ssl_visualizer_packet::set_allocated_analyzer_data(::ssl_analyzer_packet* analyzer_data) {
  delete analyzer_data_;
  analyzer_data_ = analyzer_data;
  if (analyzer_data) {
    set_has_analyzer_data();
  } else {
    clear_has_analyzer_data();
...
inline void ssl_visualizer_packet::set_allocated_decision_data(::ssl_decision_packet* decision_data) {
...
inline void ssl_visualizer_packet::set_allocated_planner_data(::ssl_planner_packet* planner_data) {
