...
class planner_circle : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_center(::planner_point2d* center);
...
class planner_plan : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_initstate(::planner_vec3d* initstate);
  ...
  inline void set_allocated_goalstate(::planner_vec3d* goalstate);
  ...
  inline void set_allocated_desiredvel(::planner_vec3d* desiredvel);
  ...
  inline void set_allocated_appliedvel(::planner_vec3d* appliedvel);
  ...
  inline void set_allocated_obstacleset(::planner_obstacles* obstacleset);
...
class ssl_planner_packet : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_plannerbound(::planner_polygon* plannerbound);
...
inline void planner_circle::set_allocated_center(::planner_point2d* center) {
  delete center_;
  center_ = center;
  if (center) {
    set_has_center();
...
inline void planner_plan::set_allocated_initstate(::planner_vec3d* initstate) {
  delete initstate_;
...
inline void planner_plan::set_allocated_goalstate(::planner_vec3d* goalstate) {
  delete goalstate_;
...
inline void planner_plan::set_allocated_desiredvel(::planner_vec3d* desiredvel) {
  delete desiredvel_;
  desiredvel_ = desiredvel;
  if (desiredvel) {
    set_has_desiredvel();
  } else {
    clear_has_desiredvel();
...
inline void planner_plan::set_allocated_appliedvel(::planner_vec3d* appliedvel) {
  delete appliedvel_;
  appliedvel_ = appliedvel;
  if (appliedvel) {
    set_has_appliedvel();
  } else {
    clear_has_appliedvel();
...
inline void planner_plan::set_allocated_obstacleset(::planner_obstacles* obstacleset) {
  delete obstacleset_;
  obstacleset_ = obstacleset;
  if (obstacleset) {
    set_has_obstacleset();
  } else {
    clear_has_obstacleset();
...
inline void ssl_planner_packet::set_allocated_plannerbound(::planner_polygon* plannerbound) {
  delete plannerbound_;
  plannerbound_ = plannerbound;
  if (plannerbound) {
    set_has_plannerbound();
  } else {
    clear_has_plannerbound();
...
inline void ssl_planner_packet::set_allocated_comment(::std::string* comment) {
  if (comment_ != &::google::protobuf::internal::kEmptyString) {
    delete comment_;
  }
  if (comment) {
