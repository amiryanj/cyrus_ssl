...
public final class SslWorld {
  ...
  public static final class ssl_world_packet extends
    ...
    public interface BallOrBuilder
      ...
      /**
       * <code>required .ssl_world_packet.vector_3d acceleration = 4;</code>
       */
      boolean hasAcceleration();
      /**
       * <code>required .ssl_world_packet.vector_3d acceleration = 4;</code>
       */
      SslWorld.ssl_world_packet.vector_3d getAcceleration();
      /**
       * <code>required .ssl_world_packet.vector_3d acceleration = 4;</code>
       */
      SslWorld.ssl_world_packet.vector_3dOrBuilder getAccelerationOrBuilder();

      // optional .ssl_world_packet.vector_3d displacement = 5;
      /**
       * <code>optional .ssl_world_packet.vector_3d displacement = 5;</code>
       */
      ...
      /**
       * <code>optional .ssl_world_packet.vector_3d velocity_raw = 6;</code>
       */
    ...
    public static final class Ball extends
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 34: {
                ...
                acceleration_ = input.readMessage(SslWorld.ssl_world_packet.vector_3d.PARSER, extensionRegistry);
                if (subBuilder != null) {
      ...
      private SslWorld.ssl_world_packet.vector_3d acceleration_;
      /**
       * <code>required .ssl_world_packet.vector_3d acceleration = 4;</code>
       */
       ...
       * <code>required .ssl_world_packet.vector_3d acceleration = 4;</code>
       */
      public SslWorld.ssl_world_packet.vector_3d getAcceleration() {
        return acceleration_;
      }
      /**
       * <code>required .ssl_world_packet.vector_3d acceleration = 4;</code>
       */
      public SslWorld.ssl_world_packet.vector_3dOrBuilder getAccelerationOrBuilder() {
        return acceleration_;
      }
      ...
      // optional .ssl_world_packet.vector_3d velocity_raw = 6;
      public static final int VELOCITY_RAW_FIELD_NUMBER = 6;
      ...
      private void initFields() {
        ...
        acceleration_ = SslWorld.ssl_world_packet.vector_3d.getDefaultInstance();
      ...
      public void writeTo(com.google.protobuf.CodedOutputStream output)
        ...
        if (((bitField0_ & 0x00000008) == 0x00000008)) {
          output.writeMessage(4, acceleration_);
        }
        if (((bitField0_ & 0x00000010) == 0x00000010)) {
          output.writeMessage(5, displacement_);
        }
        if (((bitField0_ & 0x00000020) == 0x00000020)) {
          output.writeMessage(6, velocityRaw_);
        }
        getUnknownFields().writeTo(output);
      }
      ...
      public int getSerializedSize() {
        ...
        if (((bitField0_ & 0x00000008) == 0x00000008)) {
          size += com.google.protobuf.CodedOutputStream
            .computeMessageSize(4, acceleration_);
        }
        if (((bitField0_ & 0x00000010) == 0x00000010)) {
          size += com.google.protobuf.CodedOutputStream
            .computeMessageSize(5, displacement_);
        }
        if (((bitField0_ & 0x00000020) == 0x00000020)) {
          size += com.google.protobuf.CodedOutputStream
            .computeMessageSize(6, velocityRaw_);
        }
        size += getUnknownFields().getSerializedSize();
        memoizedSerializedSize = size;
        return size;
      ...
      public static final class Builder extends
        ...
        // required .ssl_world_packet.vector_3d acceleration = 4;
        private SslWorld.ssl_world_packet.vector_3d acceleration_ = SslWorld.ssl_world_packet.vector_3d.getDefaultInstance();
        private com.google.protobuf.SingleFieldBuilder<
            SslWorld.ssl_world_packet.vector_3d, SslWorld.ssl_world_packet.vector_3d.Builder, SslWorld.ssl_world_packet.vector_3dOrBuilder> accelerationBuilder_;
        /**
         * <code>required .ssl_world_packet.vector_3d acceleration = 4;</code>
         */
        public boolean hasAcceleration() {
         ...
         * <code>required .ssl_world_packet.vector_3d acceleration = 4;</code>
         */
        public Builder setAcceleration(SslWorld.ssl_world_packet.vector_3d value) {
          if (accelerationBuilder_ == null) {
            if (value == null) {
              throw new NullPointerException();
            }
         ...
         * <code>required .ssl_world_packet.vector_3d acceleration = 4;</code>
         */
        public Builder mergeAcceleration(SslWorld.ssl_world_packet.vector_3d value) {
          if (accelerationBuilder_ == null) {
            if (((bitField0_ & 0x00000008) == 0x00000008) &&
                acceleration_ != SslWorld.ssl_world_packet.vector_3d.getDefaultInstance()) {
              acceleration_ =
                SslWorld.ssl_world_packet.vector_3d.newBuilder(acceleration_).mergeFrom(value).buildPartial();
            } else {
              acceleration_ = value;
            }
            onChanged();
         ...
         * <code>required .ssl_world_packet.vector_3d acceleration = 4;</code>
         */
        public SslWorld.ssl_world_packet.vector_3d.Builder getAccelerationBuilder() {
          bitField0_ |= 0x00000008;
          onChanged();
      ...
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_ssl_world_packet_Ball_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_ssl_world_packet_Ball_descriptor,
              new java.lang.String[] { "Id", "Position", "Velocity", "Acceleration", "Displacement", "VelocityRaw", });
          internal_static_ssl_world_packet_Robot_descriptor =
