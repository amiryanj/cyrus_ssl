...
#include "../../common/protoc/vision/cpp/messages_robocup_ssl_geometry.pb.h"
#include "../../common/protoc/vision/cpp/messages_robocup_ssl_wrapper.pb.h"
#include "../../common/protoc/vision/cpp/messages_robocup_ssl_refbox_log.pb.h"
using namespace std;
/**
	@author Author Name
*/
...
protected:
  ...
  char * in_buffer;
  QUdpSocket mc; // multicast client
//  QMutex mutex;
  int _port;
  string _net_address;
