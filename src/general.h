...
#define SSL_REFEREE_ADDRESS     "127.0.0.2" //"224.5.23.1"
...
#define GRSIM_COMMAND_ADDRESS   "127.0.0.4"  // "192.168.1.105"
#define GRSIM_COMMAND_PORT      20016

#define VISUALIZER_IP           "127.0.0.3"  // "213.233.171.39" //
